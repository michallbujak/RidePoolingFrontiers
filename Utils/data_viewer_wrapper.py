...
if __name__ == '__main__':
    ...
    # vis_eff.kpis_gain(dotmap_list, config, bins=20, y_max=18)
    ...
    vis_eff.visualize_two_shareability_graphs(g1=all_graphs_list[0]["pairs_shareability"],
                                              g2=all_graphs_list[1]["pairs_shareability"],
