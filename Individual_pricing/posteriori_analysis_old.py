...
if plot_degrees:
    ...
    objectives_to_plot = ['profitability'] + ['0' + str(t) + "_profitability" for t in [11, 2]]
    objectives_labels = ['Personalised', 'Flat disc. 0.11', 'Flat disc. 0.2']
...
if res_analysis:
    ...
    results.index = ['Personalised', 'Flat 0.11', 'Flat 0.2', 'Private only']
